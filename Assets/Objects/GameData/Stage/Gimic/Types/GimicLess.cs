...
[DataContract]
public class GimicLess : GimicBase {
    ...
    public GimicLess(
        int opportunity,
        int goal
    ) : base(type:GimicTypes.LESS, opportunity:opportunity) {
        Goal = goal;
    }
    ...
    protected override void CheckResult() {
        ...
        IsSuccess = isFulled && sum <= Goal;
        // IsFailed = (sum > Goal) || (sum + RemainOpportunity > Goal);
        IsFailed = (sum + RemainOpportunity > Goal);
    }
